...
<form method="POST" action="<?= __WEB_ROOT__ . '/admin/' . $this->data['routes-new']; ?>" class="row row-cols-1 gy-2">
    ...
    <div class="col"><input type="text" class="form-control" placeholder="Thêm tiêu đề" id="title" name="name"></div>
    <div class="col">Đường dẫn</div>
    <div class="col"><input type="text" class="form-control" placeholder="Đường dẫn" id="slug" name="slug"></div>

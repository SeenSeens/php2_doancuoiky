...
<div class="container-fluid page-header py-5">
    ...
    <ol class="breadcrumb justify-content-center mb-0">
        <li class="breadcrumb-item"><a href="<?= __WEB_ROOT__ ?>">Trang chủ</a></li>
    ...
    <div class="container py-5 text-center">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <p class="mb-4">Rất tiếc, trang bạn đang tìm kiếm không tồn tại trên trang web của chúng tôi! Bạn có thể vào trang chủ của chúng tôi hoặc thử sử dụng chức năng tìm kiếm?</p>
                <a class="btn border-secondary rounded-pill py-3 px-5" href="<?= __WEB_ROOT__ ?>">Quay lại trang chủ</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <img src="<?= __WEB_ROOT__ . '/public/frontend/img/payment.png'; ?>" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    </div>

                ...
                <div class="col mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                          ...
                          <img class="me-2" src="<?= __WEB_ROOT__ . '/public/admin/assets/images/icons/search.svg' ?>" width="16" alt="Image Description">
                          <span>Sign in with Google</span>
                                ...
                                <div class="form-body">
                                    <form class="row g-3" method="post">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" name="dangnhap" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Sign in</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
